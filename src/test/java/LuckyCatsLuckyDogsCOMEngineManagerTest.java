...
public class LuckyCatsLuckyDogsCOMEngineManagerTest {
	...
	public void setUp() throws Exception {
		logger = Logger.getLogger(LuckyCatsLuckyDogsCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LuckyCatsLuckyDogsIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LuckyCatsLuckyDogsIW/InitOutcome.xml").getDocumentElement();
